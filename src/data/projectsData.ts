...
export const projects: ProjectType[] = [
    ...
    },
    {
        title: "Fully Charged",
        shortDescription: "",
        description: "Fully charged was a BigCommerce project, developed for a company who specialized in bicycle's and bicycle equipment. This project was rather exhausting, featuring about 20+ widgets which the client could manage and organize to provide the best content without needing coding knowledge.",
        link: "https://www.fullycharged.com/",
        image: "./assets/fullycharged.jpg",
        type: ["Handlebars"],
        company: "Calashock",
        yearDate: "2022",
        status: "Online",
        ...
        bigFeatureTitle: "Widgets",
        bigFeatureDescription: "This site featured about 20+ widgets, all with the goal of allowing the clients to build their own 'pages'. The site is heavy in pages thus they needed a lot of control for each one as they tried to stay distinct. Personally the only thing I regret proposing on this project was the navigation bar being a hover. I recall bringing this up but never pressed it but looking back its truly horrible.",
    },
    {
        title: "Quickcrop",
        shortDescription: "",
